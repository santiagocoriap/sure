...
ActiveRecord::Schema[8.1].define(version: 2026_06_17_050000) do
  ...
  create_table "credit_card_installment_plans", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["account_id"], name: "index_credit_card_installment_plans_on_account_id"
    ...
    t.check_constraint "total_amount >= 0::numeric", name: "chk_cc_installment_plans_total_amount"
  end
  ...
  create_table "credit_cards", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "subtype"
    t.datetime "updated_at", null: false
    t.check_constraint "closing_day IS NULL OR closing_day >= 1 AND closing_day <= 31", name: "chk_credit_cards_closing_day"
    t.check_constraint "credit_limit IS NULL OR credit_limit >= 0::numeric", name: "chk_credit_cards_credit_limit"
    t.check_constraint "due_day IS NULL OR due_day >= 1 AND due_day <= 31", name: "chk_credit_cards_due_day"
  end
  ...
  create_table "transactions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "category_id"
    t.datetime "created_at", null: false
    t.uuid "credit_card_installment_plan_id"
    t.string "external_id"
    t.jsonb "extra", default: {}, null: false
    ...
    t.index ["credit_card_installment_plan_id", "installment_number"], name: "idx_unique_installment_per_plan", unique: true, where: "(credit_card_installment_plan_id IS NOT NULL)"
    t.index ["credit_card_installment_plan_id"], name: "index_transactions_on_credit_card_installment_plan_id"
  ...
  add_foreign_key "transactions", "credit_card_installment_plans", on_delete: :nullify
